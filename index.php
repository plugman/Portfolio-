...
<head>
  ...
  <title>Portfolio of Imran Qadir, Web Developer | Web Designer</title>
...
<div id="home">
    ...
    <div id="top_bar_i">
        <ul class="top_menu">
        <li><a href="#resume_w" data-offset="0">About Me</a></li>
        <li><a href="#projects_w" data-offset="100">My Work</a></li>
        <li><a href="#about" data-offset="100">Resume</a></li>
        <li class="logo"><a href="#resume_w" data-offset="0">&nbsp;</a></li>
        <li><a href="#services" data-offset="130">Services</a></li>
        <li><a href="#skills" data-offset="100">Skills</a></li>
        <li><a href="#contact" data-offset="160">Contact Me</a></li>
      </ul>
        <div class="clear"></div>
      </div>
  </div>
    ...
    <div class="resume_i">
        ...
        <h1 class="tk-ff-cocon-web-pro">Imran Qadir</h1>
        <h3 class="sub_name">Web Developer, Web Designer</h3>
        <div class="contact_links"> <a href="mailto:plugman@imranqadir.me">plugman@imranqadir.me</a> </div>
      </div>
        <div class="resume_main">
        <h2 id="about">About Me</h2>
        <div class="content_block">
            <p class="regular"> I'm Imran Qadir, a Lahore/Pakistan based freelance web developer 
            and designer. I passionately move pixels and lines of code to craft 
            clean, responsive, and user-friendly websites. My current weapons of 
            choice are PHP CodeIgniter, Yii, jQuery, and MySQL.
            Being both an engineer and designer, I help clients bring 
            their ideas into reality. <a href="#contact" data-offset="160">Contact me</a> today and I would love to hear about your business </p>
            <!--<p class="regular time_feature"> <span class="time">Time</span> Magazine featured one<br>
            of the websites I built on their <br>
            <a href="http://www.time.com/time/specials/packages/article/0,28804,2012721_2012929_2012926,00.html" rel="nofollow" target="_blank">"50 Best Websites of 2010"</a> list </p>-->
          </div>
        <h2>Expertise</h2>
        <h3 class="sub_header">Professional capabilities</h3>
        <div class="content_block">
            <ul class="items">
            <li>High-quality front and back-end development for web sites.</li>
            <li>Modular, scalable, robust, and reusable code.</li>
            <li>Performance optimisation, usability, and accessibility.</li>
            <li>SEO using semantic HTML and Microformats.</li>
            <li>Site planning and architecture.</li>
            <li>User interface design.</li>
          </ul>
            <h3 class="sub_header" id="skills">Technical skills</h3>
            <ul class="items">
            ...
            <li>Photoshop</li>
            <li>CSS, HTML, SASS, Compass CSS, Blueprint</li>
            <li>Linux, Apache, SQL, GIT</li>
          </ul>
          </div>
        <h2>Experience</h2>
        <div class="content_block">
            <ul class="big_items">
            <li>
                <h4>Lead Developer, Designer <span>@WebCreation</span></h4>
                <p class="info">August 2012–Present</p>
                <p class="desc">Responsible for Product Design, Development 
                and Linux Cloud Server Setup. Yii, Cubecart, jQuery, CoffeeScript, 
                Compass CSS, Server Administration.</p>
              </li>
            <li>
                <h4>Lead Developer, Designer <span>@ModsIndex</span></h4>
                <p class="info">December 2012–Present</p>
                <p class="desc">Responsible for Product Design, Development and Linux Cloud Server Setup. Codeigniter PHP, Yii, jQuery, Server Administration.</p>
              </li>
            <li>
                <h4>Lead Developer, Designer <span>@ImeiUnlock</span></h4>
                <p class="info">February 2012–Present</p>
                <p class="desc">Responsible for Product Design, Development and Linux Cloud Server Setup. Codeigniter PHP, Yii, jQuery, Server Administration.</p>
              </li>
        ...
        <div class="content_block">
            ...
            <li>
                ...
                <p>~ Master of Computer Science / 2010–2012</p>
              </li>
          </ul>
          </div>
        <div class="footer_links"> <a href="https://www.facebook.com/ImIaMrAn" rel="nofollow">Facebook</a> | <a href="https://www.linkedin.com/pub/imran-qadir/a5/336/809" rel="nofollow">LinkedIn</a> | <a href="mailto:plugman@imranqadir.me">Email</a> </div>
      </div>
      </div>
  </div>
    <!--<div id="projects_w">
