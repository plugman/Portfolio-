...
! function(e, t) {
    ...
    function B(e, t, n) {
        var r, i, o = 0,
            ...
            u = function() {
                if (i) return !1;
                for (var t = Zn || R(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, a = 0, u = l.tweens.length; u > a; a++) l.tweens[a].run(o);
        ...
        return ct.map(c, $, l), ct.isFunction(l.opts.start) && l.opts.start.call(e, l), ct.fx.timer(ct.extend(u, {
            elem: e,
            anim: l,
            queue: l.opts.queue
    ...
    function W(e, t, n) {
        ...
        if (!ct.isEmptyObject(c)) {
            ...
            for (r in c) a = $(p ? d[r] : 0, r, l), r in d || (d[r] = a.start, p && (a.end = a.start, a.start = "width" === r || "height" === r ? 1 : 0))
        }
    }
    ...
    ct.fn = ct.prototype = {
        ...
        function(e, t) {
            function n(e, t, n, r) {
                ...
                if ((t ? t.ownerDocument || t : z) !== M && F(t), t = t || M, n = n || [], !e || "string" != typeof e) return n;
                ...
                if (R && !r) {
                    if (i = Ct.exec(e))
                        if (a = i[1]) {
                            ...
                            } else if (t.ownerDocument && (o = t.ownerDocument.getElementById(a)) && W(t, o) && o.id === a) return n.push(o), n
                        } else {
                    ...
                    if (S.qsa && (!$ || !$.test(e))) {
                        if (f = c = I, p = t, d = 9 === s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
                            for (l = m(e), (c = t.getAttribute("id")) ? f = c.replace(Et, "\\$&") : t.setAttribute("id", f), f = "[id='" + f + "'] ", u = l.length; u--;) l[u] = f + g(l[u]);
            ...
            function m(e, t) {
                ...
                for (s = e, u = [], l = A.preFilter; s;) {
                    (!r || (i = mt.exec(s))) && (i && (s = s.slice(i[0].length) || s), u.push(o = [])), r = !1, (i = gt.exec(s)) && (r = i.shift(), o.push({
                        value: r,
                        type: i[0].replace(ht, " ")
                    }), s = s.slice(r.length));
                    for (a in A.filter) !(i = wt[a].exec(s)) || l[a] && !(i = l[a](i)) || (r = i.shift(), o.push({
                        value: r,
                        type: a,
                        matches: i
                    }), s = s.slice(r.length));
                    ...
                    if (a) {
                        ...
                        for (; t = t[r];)
                            if (1 === t.nodeType || i)
                                ...
                                } else if (u = l[r] = [c], u[1] = e(t, n, a) || j, u[1] === !0) return !0
                }
            }
            ...
            function x(e, t, n, r, i, a) {
                return r && !r[I] && (r = x(r)), i && !i[I] && (i = x(i, a)), o(function(o, a, s, u) {
                    var l, c, f, p = [],
                        ...
                        g = !e || !o && t ? m : b(m, p, e, s, u),
                        y = n ? i || (o ? e : h || r) ? [] : a : g;
                    if (n && n(g, y, s, u), r)
                        for (l = b(y, d), r(l, [], s, u), c = l.length; c--;)(f = l[c]) && (y[d[c]] = !(g[d[c]] = f));
                    if (o) {
                        if (i || e) {
                            if (i) {
            ...
            function T(e, t) {
                var r = 0,
                    ...
                    s = function(o, s, u, l, c) {
                        ...
                        for (v && (_ = s !== M && s, j = r); null != (f = w[g]); g++) {
                            if (a && f) {
                                for (p = 0; d = e[p++];)
                                    if (d(f, s, u)) {
                                        l.push(f);
                        ...
                        if (m += g, i && g !== m) {
                            ...
                            if (o) {
                                if (m > 0)
                                    for (; g--;) y[g] || h[g] || (h[g] = nt.call(l));
                                h = b(h)
                            }
                            it.apply(l, h), v && !o && h.length > 0 && m + t.length > 1 && n.uniqueSort(l)
                        }
                        return v && (X = T, _ = x), y
                    };
                return i ? o(s) : s
            ...
            function k(e, t, n, r) {
                var i, o, a, s, u, l = m(e);
                if (!r && 1 === l.length) {
                    if (o = l[0] = l[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && S.getById && 9 === t.nodeType && R && A.relative[o[1].type]) {
                ...
                return H(e, l)(r, t, !R, n, yt.test(e)), n
            }

            function N() {}
            var E, S, j, A, D, L, H, _, q, F, M, O, R, $, B, P, W, I = "sizzle" + -new Date,
                z = e.document,
                X = 0,
                U = 0,
                Y = i(),
            ...
            L = n.isXML = function(e) {
                ...
                return t !== M && 9 === t.nodeType && t.documentElement ? (M = t, O = t.documentElement, R = !L(t), n && n.frameElement && n.attachEvent("onbeforeunload", function() {
                    ...
                    return O.appendChild(e).id = I, !t.getElementsByName || !t.getElementsByName(I).length
                ...
                }, B = [], $ = [], (S.qsa = r(t.querySelectorAll)) && (a(function(e) {
                    e.innerHTML = "<select><option selected=''></option></select>", e.querySelectorAll("[selected]").length || $.push("\\[" + ut + "*(?:value|" + st + ")"), e.querySelectorAll(":checked").length || $.push(":checked")
                }), a(function(e) {
                    var n = t.createElement("input");
                    n.setAttribute("type", "hidden"), e.appendChild(n).setAttribute("t", ""), e.querySelectorAll("[t^='']").length && $.push("[*^$]=" + ut + "*(?:''|\"\")"), e.querySelectorAll(":enabled").length || $.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), $.push(",.*:")
                })), (S.matchesSelector = r(P = O.webkitMatchesSelector || O.mozMatchesSelector || O.oMatchesSelector || O.msMatchesSelector)) && a(function(e) {
                    S.disconnectedMatch = P.call(e, "div"), P.call(e, "[s!='']:x"), B.push("!=", dt)
                }), $ = $.length && new RegExp($.join("|")), B = B.length && new RegExp(B.join("|")), W = r(O.contains) || O.compareDocumentPosition ? function(e, t) {
                    ...
                    return r ? 1 & r || !S.sortDetached && n.compareDocumentPosition(e) === r ? e === t || W(z, e) ? -1 : n === t || W(z, n) ? 1 : q ? at.call(q, e) - at.call(q, n) : 0 : 4 & r ? -1 : 1 : e.compareDocumentPosition ? -1 : 1
                } : function(e, n) {
                    var r, i = 0,
                        o = e.parentNode,
                        a = n.parentNode,
                ...
                if ((e.ownerDocument || e) !== M && F(e), t = t.replace(vt, "='$1']"), !(!S.matchesSelector || !R || B && B.test(t) || $ && $.test(t))) try {
                    var r = P.call(e, t);
                ...
                var r = A.attrHandle[n.toLowerCase()],
                    i = r && et.call(A.attrHandle, n.toLowerCase()) ? r(e, n, !R) : t;
                ...
                var t, n = [],
                    r = 0,
                    i = 0;
                if (G = !S.detectDuplicates, q = !S.sortStable && e.slice(0), e.sort(K), G) {
                        ...
                        return 1 === r && 0 === i ? function(e) {
                            ...
                            if (g) {
                                ...
                                if (h = [a ? g.firstChild : g.lastChild], a && v) {
                                    for (c = g[I] || (g[I] = {}), l = c[e] || [], d = l[0] === X && l[1], p = l[0] === X && l[2], f = d && g.childNodes[d]; f = ++d && f && f[m] || (p = d = 0) || h.pop();)
                                    ...
                                    for (;
                                        (f = ++d && f && f[m] || (p = d = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== y : 1 !== f.nodeType) || !++p || (v && ((f[I] || (f[I] = {}))[e] = [X, p]), f !== t)););
                ...
                pseudos: {
                    ...
                    lang: o(function(e) {
                        return xt.test(e || "") || n.error("unsupported lang: " + e), e = e.replace(St, jt).toLowerCase(),
                            function(t) {
                                var n;
                                do
            ...
            H = n.compile = function(e, t) {
                var n, r = [],
                    ...
                    o = J[e + " "];
                if (!o) {
                    for (t || (t = m(e)), n = t.length; n--;) o = w(t[n]), o[I] ? r.push(o) : i.push(o);
                    o = J(e, T(i, r))
                }
                return o
            }, A.pseudos.nth = A.pseudos.eq, N.prototype = A.filters = A.pseudos, A.setFilters = new N, S.sortStable = I.split("").sort(K).join("") === I, F(), [0, 0].sort(K), S.detectDuplicates = G, ct.find = n, ct.expr = n.selectors, ct.expr[":"] = ct.expr.pseudos, ct.unique = n.uniqueSort, ct.text = n.getText, ct.isXMLDoc = n.isXML, ct.contains = n.contains
        }(e);
    var Nt = {};
    ct.Callbacks = function(e) {
        ...
        when: function(e) {
            ...
            if (a > 1)
                for (t = new Array(a), n = new Array(a), r = new Array(a); a > i; i++) o[i] && ct.isFunction(o[i].promise) ? o[i].promise().done(l(i, r, o)).fail(u.reject).progress(l(i, n, t)) : --s;
        ...
        return t.ownLast = "0" !== c, ct(function() {
            ...
            a && (n = G.createElement("div"), n.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px", a.appendChild(n).appendChild(f), f.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", i = f.getElementsByTagName("td"), i[0].style.cssText = "padding:0;margin:0;border:0;display:none", l = 0 === i[0].offsetHeight, i[0].style.display = "", i[1].style.display = "none", t.reliableHiddenOffsets = l && 0 === i[0].offsetHeight, f.innerHTML = "", f.style.cssText = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;", ct.swap(a, null != a.style.zoom ? {
                ...
                width: "4px"
            }).width, r = f.appendChild(G.createElement("div")), r.style.cssText = f.style.cssText = o, r.style.marginRight = r.style.width = "0", f.style.width = "1px", t.reliableMarginRight = !parseFloat((e.getComputedStyle(r, null) || {}).marginRight)), typeof f.style.zoom !== V && (f.innerHTML = "", f.style.cssText = o + "width:1px;padding:1px;display:inline;zoom:1", t.inlineBlockNeedsLayout = 3 === f.offsetWidth, f.style.display = "block", f.innerHTML = "<div></div>", f.firstChild.style.width = "5px", t.shrinkWrapBlocks = 3 !== f.offsetWidth, t.inlineBlockNeedsLayout && (a.style.zoom = 1)), a.removeChild(n), n = f = i = r = null)
        }), n = o = a = s = r = i = null, t
    }({});
    var Et = /(?:\{[\s\S]*\}|\[[\s\S]*\])$/,
        St = /([A-Z])/g;
    ...
    ct.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return ct.isFunction(e) ? this.each(function(n) {
                ...
                if ("string" === n)
                    for (var i, o = 0, a = ct(this), s = t, u = e.match(pt) || []; i = u[o++];) s = r ? s : !a.hasClass(i), a[s ? "addClass" : "removeClass"](i);
        ...
        attr: function(e, n, r) {
            ...
            if (e && 3 !== a && 8 !== a && 2 !== a) return typeof e.getAttribute === V ? ct.prop(e, n, r) : (1 === a && ct.isXMLDoc(e) || (n = n.toLowerCase(), i = ct.attrHooks[n] || (ct.expr.match.bool.test(n) ? At : jt)), r === t ? i && "get" in i && null !== (o = i.get(e, n)) ? o : (o = ct.find.attr(e, n), null == o ? t : o) : null !== r ? i && "set" in i && (o = i.set(e, r, n)) !== t ? o : (e.setAttribute(n, r + ""), r) : (ct.removeAttr(e, n), void 0))
        },
        removeAttr: function(e, t) {
            var n, r, i = 0,
                o = t && t.match(pt);
            if (o && 1 === e.nodeType)
                for (; n = o[i++];) r = ct.propFix[n] || n, ct.expr.match.bool.test(n) ? Mt && Ft || !qt.test(n) ? e[r] = !1 : e[ct.camelCase("default-" + n)] = e[r] = !1 : ct.attr(e, n, ""), e.removeAttribute(Ft ? n : r)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
        ...
        set: function(e, t, n) {
            return t === !1 ? ct.removeAttr(e, n) : Mt && Ft || !qt.test(n) ? e.setAttribute(!Ft && ct.propFix[n] || n, n) : e[ct.camelCase("default-" + n)] = e[n] = !0, n
        }
    }, ct.each(ct.expr.match.bool.source.match(/\w+/g), function(e, n) {
        var r = ct.expr.attrHandle[n] || ct.find.attr;
        ct.expr.attrHandle[n] = Mt && Ft || !qt.test(n) ? function(e, n, i) {
    ...
    ct.event = {
        ...
        add: function(e, n, r, i, o) {
            var a, s, u, l, c, f, p, d, h, m, g, y = ct._data(e);
            if (y) {
                for (r.handler && (l = r, r = l.handler, o = l.selector), r.guid || (r.guid = ct.guid++), (s = y.events) || (s = y.events = {}), (f = y.handle) || (f = y.handle = function(e) {
                        return typeof ct === V || e && ct.event.triggered === e.type ? t : ct.event.dispatch.apply(f.elem, arguments)
                    }, f.elem = e), n = (n || "").match(pt) || [""], u = n.length; u--;) a = Pt.exec(n[u]) || [], h = g = a[1], m = (a[2] || "").split(".").sort(), h && (c = ct.event.special[h] || {}, h = (o ? c.delegateType : c.bindType) || h, c = ct.event.special[h] || {}, p = ct.extend({
                    type: h,
                    origType: g,
                    data: i,
                    handler: r,
                    ...
                    namespace: m.join(".")
                }, l), (d = s[h]) || (d = s[h] = [], d.delegateCount = 0, c.setup && c.setup.call(e, i, m, f) !== !1 || (e.addEventListener ? e.addEventListener(h, f, !1) : e.attachEvent && e.attachEvent("on" + h, f))), c.add && (c.add.call(e, p), p.handler.guid || (p.handler.guid = r.guid)), o ? d.splice(d.delegateCount++, 0, p) : d.push(p), ct.event.global[h] = !0);
                e = null
            }
        },
        remove: function(e, t, n, r, i) {
            var o, a, s, u, l, c, f, p, d, h, m, g = ct.hasData(e) && ct._data(e);
            if (g && (c = g.events)) {
                for (t = (t || "").match(pt) || [""], l = t.length; l--;)
                    if (s = Pt.exec(t[l]) || [], d = m = s[1], h = (s[2] || "").split(".").sort(), d) {
                        for (f = ct.event.special[d] || {}, d = (r ? f.delegateType : f.bindType) || d, p = c[d] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), u = o = p.length; o--;) a = p[o], !i && m !== a.origType || n && n.guid !== a.guid || s && !s.test(a.namespace) || r && r !== a.selector && ("**" !== r || !a.selector) || (p.splice(o, 1), a.selector && p.delegateCount--, f.remove && f.remove.call(e, a));
                        u && !p.length && (f.teardown && f.teardown.call(e, h, g.handle) !== !1 || ct.removeEvent(e, d, g.handle), delete c[d])
                    } else
        ...
        trigger: function(n, r, i, o) {
            ...
            if (u = f = i = i || G, 3 !== i.nodeType && 8 !== i.nodeType && !Bt.test(h + ct.event.triggered) && (h.indexOf(".") >= 0 && (m = h.split("."), h = m.shift(), m.sort()), s = h.indexOf(":") < 0 && "on" + h, n = n[ct.expando] ? n : new ct.Event(h, "object" == typeof n && n), n.isTrigger = o ? 2 : 3, n.namespace = m.join("."), n.namespace_re = n.namespace ? new RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, n.result = t, n.target || (n.target = i), r = null == r ? [n] : ct.makeArray(r, [n]), c = ct.event.special[h] || {}, o || !c.trigger || c.trigger.apply(i, r) !== !1)) {
        ...
        fix: function(e) {
            ...
            var t, n, r, i = e.type,
                o = e,
                a = this.fixHooks[i];
            for (a || (this.fixHooks[i] = a = $t.test(i) ? this.mouseHooks : Rt.test(i) ? this.keyHooks : {}), r = a.props ? this.props.concat(a.props) : this.props, e = new ct.Event(o), t = r.length; t--;) n = r[t], e[n] = o[n];
    ...
    sn.optgroup = sn.option, sn.tbody = sn.tfoot = sn.colgroup = sn.caption = sn.thead, sn.th = sn.td, ct.fn.extend({
        ...
        html: function(e) {
            return ct.access(this, function(e) {
                ...
                if (!("string" != typeof e || en.test(e) || !ct.support.htmlSerialize && Vt.test(e) || !ct.support.leadingWhitespace && Jt.test(e) || sn[(Kt.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(Gt, "<$1></$2>");
                    try {
        ...
        domManip: function(e, t, n) {
            ...
            if (c && (u = ct.buildFragment(e, this[0].ownerDocument, !1, !n && this), r = u.firstChild, 1 === u.childNodes.length && (u = r), r)) {
                for (a = ct.map(x(u, "script"), m), o = a.length; c > l; l++) i = u, l !== p && (i = ct.clone(i, !0, !0), o && ct.merge(a, x(i, "script"))), t.call(this[l], i, l);
                if (o)
        ...
        buildFragment: function(e, t, n, r) {
            for (var i, o, a, s, u, l, c, f = e.length, p = d(t), h = [], m = 0; f > m; m++)
                if (o = e[m], o || 0 === o)
                    if ("object" === ct.type(o)) ct.merge(h, o.nodeType ? [o] : o);
                    else if (Zt.test(o)) {
                for (s = s || p.appendChild(t.createElement("div")), u = (Kt.exec(o) || ["", ""])[1].toLowerCase(), c = sn[u] || sn._default, s.innerHTML = c[1] + o.replace(Gt, "<$1></$2>") + c[2], i = c[0]; i--;) s = s.lastChild;
                if (!ct.support.leadingWhitespace && Jt.test(o) && h.push(t.createTextNode(Jt.exec(o)[0])), !ct.support.tbody)
                    for (o = "table" !== u || Qt.test(o) ? "<table>" !== c[1] || Qt.test(o) ? 0 : s : s.firstChild, i = o && o.childNodes.length; i--;) ct.nodeName(l = o.childNodes[i], "tbody") && !l.childNodes.length && o.removeChild(l);
    ...
    ct.fn.extend({
        ...
        css: function(e, n, r, i) {
            var o, a, s, u = ct.camelCase(n);
            return n = ct.cssProps[u] || (ct.cssProps[u] = T(e.style, u)), s = ct.cssHooks[n] || ct.cssHooks[u], s && "get" in s && (a = s.get(e, !0, r)), a === t && (a = pn(e, n, i)), "normal" === a && n in Cn && (a = Cn[n]), "" === r || r ? (o = parseFloat(a), r === !0 || ct.isNumeric(o) ? o || 0 : a) : a
        }
    ...
    Ln = Pn.exec(Hn.toLowerCase()) || [], ct.fn.load = function(e, n, r) {
        ...
        ajax: function(e, n) {
            function r(e, n, r, i) {
                var o, f, v, b, w, C = n;
                2 !== x && (x = 2, u && clearTimeout(u), c = t, s = i || "", T.readyState = e > 0 ? 4 : 0, o = e >= 200 && 300 > e || 304 === e, r && (b = q(p, T, r)), b = F(p, b, T, o), o ? (p.ifModified && (w = T.getResponseHeader("Last-Modified"), w && (ct.lastModified[a] = w), w = T.getResponseHeader("etag"), w && (ct.etag[a] = w)), 204 === e || "HEAD" === p.type ? C = "nocontent" : 304 === e ? C = "notmodified" : (C = b.state, f = b.data, v = b.error, o = !v)) : (v = C, (e || !C) && (C = "error", 0 > e && (e = 0))), T.status = e, T.statusText = (n || C) + "", o ? m.resolveWith(d, [f, C, T]) : m.rejectWith(d, [T, C, v]), T.statusCode(y), y = t, l && h.trigger(o ? "ajaxSuccess" : "ajaxError", [T, p, o ? f : v]), g.fireWith(d, [T, C]), l && (h.trigger("ajaxComplete", [T, p]), --ct.active || ct.event.trigger("ajaxStop")))
            }
            ...
            if (m.promise(T).complete = g.add, T.success = T.done, T.error = T.fail, p.url = ((e || p.url || Hn) + "").replace(Fn, "").replace(Bn, Ln[1] + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = ct.trim(p.dataType || "*").toLowerCase().match(pt) || [""], null == p.crossDomain && (i = Pn.exec(p.url.toLowerCase()), p.crossDomain = !(!i || i[1] === Ln[1] && i[2] === Ln[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === (Ln[3] || ("http:" === Ln[1] ? "80" : "443")))), p.data && p.processData && "string" != typeof p.data && (p.data = ct.param(p.data, p.traditional)), H(In, p, n, T), 2 === x) return T;
            l = p.global, l && 0 === ct.active++ && ct.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !$n.test(p.type), a = p.url, p.hasContent || (p.data && (a = p.url += (qn.test(a) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (p.url = Mn.test(a) ? a.replace(Mn, "$1_=" + _n++) : a + (qn.test(a) ? "&" : "?") + "_=" + _n++)), p.ifModified && (ct.lastModified[a] && T.setRequestHeader("If-Modified-Since", ct.lastModified[a]), ct.etag[a] && T.setRequestHeader("If-None-Match", ct.etag[a])), (p.data && p.hasContent && p.contentType !== !1 || n.contentType) && T.setRequestHeader("Content-Type", p.contentType), T.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Xn + "; q=0.01" : "") : p.accepts["*"]);
    ...
    ct.ajaxSetup({
        ...
        return u || "jsonp" === n.dataTypes[0] ? (o = n.jsonpCallback = ct.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback, u ? n[u] = n[u].replace(Vn, "$1" + o) : n.jsonp !== !1 && (n.url += (qn.test(n.url) ? "&" : "?") + n.jsonp + "=" + o), n.converters["script json"] = function() {
            return s || ct.error(o + " was not called"), s[0]
        }, n.dataTypes[0] = "json", a = e[o], e[o] = function() {
            s = arguments
        }, i.always(function() {
            e[o] = a, n[o] && (n.jsonpCallback = r.jsonpCallback, Yn.push(o)), s && ct.isFunction(a) && a(s[0]), s = a = t
        }), "script") : void 0
    });
    var Jn, Gn, Kn = 0,
                    ...
                    u.send(n.hasContent && n.data || null), r = function(e, i) {
                        ...
                        try {
                            if (r && (i || 4 === u.readyState))
                                if (r = t, a && (u.onreadystatechange = ct.noop, Qn && delete Jn[a]), i) 4 !== u.readyState && u.abort();
                                else {
                        ...
                        f && o(s, c, f, l)
                    }, n.async ? 4 === u.readyState ? setTimeout(r) : (a = ++Kn, Qn && (Jn || (Jn = {}, ct(e).unload(Qn)), Jn[a] = r), u.onreadystatechange = r) : r()
                },
                abort: function() {
                    r && r(t, !0)
                }
    ...
    ct.Animation = ct.extend(B, {
        ...
        var n, r, i = {
            ...
            o = this[0],
            a = o && o.ownerDocument;
        if (a) return n = a.documentElement, ct.contains(n, o) ? (typeof o.getBoundingClientRect !== V && (i = o.getBoundingClientRect()), r = X(a), {
...
function() {
    $(function() {
        return $("a").click(function() {
            var e;
            return e = $($(this).attr("href")).offset().top - $(this).data("offset"), $("html, body").animate({
                scrollTop: e
            }, 700), !1
        }), $("#contact_form").submit(function() {
            var e, t;
            return t = [], $("#contact_name").val() || t.push("Your Name"), $("#contact_email").val() || t.push("Your Email"), $("#contact_message").val() || t.push("Message"), t.length ? ($(".error_message").remove(), e = $("<div/>").text("Required: " + t.toString()).addClass("error_message"), $("#contact_form").prepend(e), !1) : ($("#contact_send").text("Loading..."), $.ajax({
